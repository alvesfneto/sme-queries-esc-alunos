...
--DROP VIEW vw_unidades_diretas_setores_internos_sme_dre_ceus
CREATE VIEW vw_unidades_diretas_setores_internos_sme_dre_ceus AS
SELECT 
...
FROM [DB_EDUCACAO_1_PRODAM].[se1426_ss].[dbo].[v_unidade_educacao_dados_gerais] A
...
--select * from vw_unidades_diretas_setores_internos_sme_dre_ceus
