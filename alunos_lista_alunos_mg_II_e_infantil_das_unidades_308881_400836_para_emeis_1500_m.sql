...
CASE WHEN A.CD_ESCOLA <> B.CD_ESCOLA THEN
FLOOR(FLOOR(SQRT(POWER((LAT_ALUNO * 1000000 - ( CD_COORDENADA_GEO_Y * 1000000) ),2) +  POWER((LON_ALUNO * 1000000  - (CD_COORDENADA_GEO_X * 1000000)),2)) / 10)/0.6)
ELSE NULL END  AS DISTANCIA
...
SELECT * 
INTO ##LISTA_ALUNOS_MGII_E_INFANTIL_UNIDADES_308881_400836_PARA_EMEIS_1
FROM ##LISTA_ALUNOS_MGII_E_INFANTIL_UNIDADES_308881_400836_PARA_EMEIS WHERE DISTANCIA IS NOT NULL
