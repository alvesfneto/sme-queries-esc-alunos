/*
CÓDIGO QUE GERA A TBL_ENDERECOS_ALUNOS_COM_RESPONSAVEIS

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
--DROP TABLE TBL_ENDERECOS_ALUNOS_COM_RESPONSAVEIS

SELECT distinct 
I.DRE,
I.CD_DIST,
--K.nm_distrito_mec AS DISTR_ESCOLA,
I.CD_ESCOLA,
I.SG_TP_ESCOLA,
...
D.cd_cep AS CEP, 
D.cd_distrito_mec AS CD_DISTR_ALU,
--J.nm_distrito_mec AS DISTR_ALUNO,
...
INTO TBL_ENDERECOS_ALUNOS_COM_RESPONSAVEIS
...
--SELECT * FROM TBL_ENDERECOS_ALUNOS_COM_RESPONSAVEIS
