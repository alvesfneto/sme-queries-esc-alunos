...
em relação a 
EMEI João Theodoro - 091880 e 
EMEI Alceu Maynard de Araujo - 091898.

CR.P.CONV. Casa Dom Gastão -          306402 --select cd_sit,cd_escola,nomesc,sg_tp_escola from sme_escola_diario where nomesc like '%social da crianca%' and dre = 'dre - ip'
CR.P.CONV. Grão de Gente II -         306408
CR.P.CONV. Lar Criança Feliz -        400480
CR.P.CONV. Centro Social da Criança - 306540
