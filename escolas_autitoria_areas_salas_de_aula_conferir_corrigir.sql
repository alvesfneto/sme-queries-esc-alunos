...
COUNT( CASE WHEN AREA_AMBIENTE <10 THEN DC_TIPO_AMBIENTE ELSE NULL END) AS '<10 M2',
COUNT( CASE WHEN AREA_AMBIENTE BETWEEN 10 AND 19 THEN DC_TIPO_AMBIENTE ELSE NULL END) AS '10 A 19 M2',
...
WHERE AREA_AMBIENTE <10 OR AREA_AMBIENTE >=60 AND CD_SIT=1
--select * from ##SL_AULA_REVISAR_AREA where sg_tp_escola<>'ESC.PART.'
