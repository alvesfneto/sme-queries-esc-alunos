...
--ENDEREÇO 1
DECLARE @END NVARCHAR(200) SET @END = 'R. Otaviano Basílio da Silva, 178 - Brasilândia. São Paulo - SP'
DECLARE @LAT_Y FLOAT SET @LAT_Y = -23.470218872428045      
DECLARE	@LON_X FLOAT SET @LON_X = -46.69232247455336 
INSERT INTO TAB_END  
SELECT @END,@LAT_Y, @LON_X,  SYSDATETIME() WHERE @LAT_Y IS NOT NULL
GO
/*
--ENDEREÇO 2
DECLARE @END NVARCHAR(200) SET @END = 'Vieira de Melo'
DECLARE @LAT_Y FLOAT SET @LAT_Y = -23.451622
DECLARE	@LON_X FLOAT SET @LON_X = -46.614452
INSERT INTO TAB_END  
SELECT @END,@LAT_Y, @LON_X,  SYSDATETIME() WHERE @LAT_Y IS NOT NULL
GO
--ENDEREÇO 3
