...
--ENDEREÇO 1
DECLARE @END NVARCHAR(200) SET @END = 'Rua Dr. Azevedo Lima, 437'
DECLARE @LAT_Y FLOAT SET @LAT_Y =    -23.468083968933282    
DECLARE	@LON_X FLOAT SET @LON_X =    -46.56761318985693
INSERT INTO TAB_END  
