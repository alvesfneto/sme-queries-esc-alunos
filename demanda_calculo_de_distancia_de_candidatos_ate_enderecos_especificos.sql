...
--ENDEREÇO 1
DECLARE @END NVARCHAR(200) SET @END = 'Rua Augusto Rodrigues, 291 - JARDIM FONTÁLIS CEP 02360-010'
DECLARE @LAT_Y FLOAT SET @LAT_Y =  -23.437794332067362      
DECLARE	@LON_X FLOAT SET @LON_X =  -46.577716645877096
INSERT INTO TAB_END  
