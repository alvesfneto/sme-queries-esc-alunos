...
/****** Object:  Job [Baixa_tabelas_diario]    Script Date: 23/04/2024 08:31:23 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 23/04/2024 08:31:23 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Baixa_tabelas_diario', 
		@enabled=1, 
		...
		@owner_login_name=N'EDUCACAO\6960545', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [baixa_tabelas]    Script Date: 23/04/2024 08:31:23 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'baixa_tabelas', 
		@step_id=1, 
		...
		@command=N'/*****ESTA ROTINA BAIXA AS TABELAS DO DIA ANTERIOR 
...
--SELECT * FROM D_ficha_validacao_veiculo
...
', 
		@database_name=N'Db_local', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_update_job @job_id = @jobId, @start_step_id = 1
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'programacao', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'b963ad3f-c97b-482e-b1e9-82e0ad58eb7b'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
