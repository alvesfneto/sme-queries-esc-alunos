...
IF EXISTS 
	(SELECT 'TRUE' FROM SYSOBJECTS WHERE NAME = 'M_SERIE_TURMA_ESCOLA')
DROP TABLE M_SERIE_TURMA_ESCOLA
SELECT *, GETDATE() AS CRDATE INTO Db_Local.DBO.M_SERIE_TURMA_ESCOLA						
FROM [DB_EDUCACAO_1_PRODAM].[se1426_ss].[dbo].[SERIE_TURMA_ESCOLA]
GO

IF EXISTS (SELECT * FROM Db_local.DBO.SYSOBJECTS WHERE NAME = 'M_TURMA_GRADE_TERRITORIO_EXPERIENCIA') DROP TABLE M_TURMA_GRADE_TERRITORIO_EXPERIENCIA
...
IF EXISTS (SELECT * FROM Db_local.DBO.SYSOBJECTS WHERE NAME = 'M_ESCOLA_GRADE') DROP TABLE M_ESCOLA_GRADE
SELECT *,GETDATE() AS CRDATE INTO D_ESCOLA_GRADE FROM DB_EDUCACAO_1_PRODAM.se1426_ss.[dbo].[ESCOLA_GRADE]
GO

IF EXISTS (SELECT * FROM Db_local.DBO.SYSOBJECTS WHERE NAME = 'M_GRADE') DROP TABLE M_GRADE
SELECT *,GETDATE() AS CRDATE INTO D_GRADE FROM DB_EDUCACAO_1_PRODAM.se1426_ss.[dbo].[GRADE]
GO

IF EXISTS (SELECT * FROM Db_local.DBO.SYSOBJECTS WHERE NAME = 'M_TERRITORIO_SABER') DROP TABLE M_TERRITORIO_SABER
SELECT *,GETDATE() AS CRDATE INTO D_TERRITORIO_SABER FROM DB_EDUCACAO_1_PRODAM.se1426_ss.[dbo].[TERRITORIO_SABER]
GO

IF EXISTS (SELECT * FROM Db_local.DBO.SYSOBJECTS WHERE NAME = 'M_TIPO_EXPERIENCIA_PEDAGOGICA') DROP TABLE M_TIPO_EXPERIENCIA_PEDAGOGICA
