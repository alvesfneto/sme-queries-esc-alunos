...
SELECT DISTINCT
	--CAMPOS DA TABELA SME_ESCOLA_DIARIO
	A.DRE,
	A.CD_ESCOLA,
	A.SG_TP_ESCOLA,
	A.NOMESC,
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='BT')
DROP TABLE BT
SELECT *
INTO BT
...
--SELECT * FROM BT
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='CL')
DROP TABLE CL
SELECT *
INTO CL
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='CS')
DROP TABLE CS
SELECT *
INTO CS
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='FB')
DROP TABLE FB
SELECT *
INTO FB
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='G')
DROP TABLE G
SELECT *
INTO G
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='IP')
DROP TABLE IP
SELECT *
INTO IP
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='IQ')
DROP TABLE IQ
SELECT *
INTO IQ
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='JT')
DROP TABLE JT
SELECT *
INTO JT
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MP')
DROP TABLE MP
SELECT *
INTO MP
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='PE')
DROP TABLE PE
SELECT *
INTO PE
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='PJ')
DROP TABLE PJ
SELECT *
INTO PJ
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='SA')
DROP TABLE SA
SELECT *
INTO SA
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='SM')
DROP TABLE SM
SELECT *
INTO SM
FROM DEMANDA_POR_ESCOLA_COM_PREF
...
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='D_ALUNOS_ED_INFANTIL')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_BT')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_CL')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_CS')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_FB')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_G')
DROP TABLE MT_INF_G
SELECT *
INTO MT_INF_G
FROM D_ALUNOS_ED_INFANTIL
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_IP')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_IQ')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_JT')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_MP')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_PE')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_PJ')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_SA')
...
-------------------------------------------------------------------------------------------------------
IF EXISTS 
(SELECT 'TRUE' FROM Db_Local_0..SYSOBJECTS WHERE NAME ='MT_INF_SM')
